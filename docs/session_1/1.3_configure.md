...
!!! example "Exercise 1.3.6.5"
    ...
    Create a new file called `profiles.config` and write a new profile that includes the custom configuration file you wrote in Exercise 1.3.6.4. Try running with and without the new profile enabled.
