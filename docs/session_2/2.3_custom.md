...
!!! example "Exercise 2.3.4.5.2 :stopwatch: 5 mins"
    ...
    ??? success "Solution"
        ...
        !!! info "Customisation specificity"

        HISAT2_ALIGN has used our custom version, ***but*** not the other Hisat modules! 🗒️ We make a note to update our hisat2 config file to ensure all Hisat2 modules use the new version, as **version consistency** within data analysis is crucial for reproducibility and preventing version conflicts.  
