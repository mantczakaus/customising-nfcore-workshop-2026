...
![](../assets/2.4_screenshot_config_list.png)
...
![](../assets/2.4_screenshot_custom_trace.png)
...
!!! note "Reminder: Viewing the MultiQC HTML"
...
!!! note "When `extra_<tool>_args` is not available :scream:"
...
!!! tip "If you have not yet run this version of the pipeline"
...
!!! important "Disclaimer :hand_over_mouth:"
...
![](../assets/2.4_trimgalore_qual_decision_chart.png)
