# 2.2 Managing parameter reproducibility
...
!!! warning "Handling dodgy error messages :face_with_symbols_over_mouth:"
...
!!! tip "Hidden files in the work directory!"
...
!!! note "How do I get rid of the strandedness check warning message?"
