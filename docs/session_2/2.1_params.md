...
nf-core have provided a safe-guard against incomplete run records by including your run command as well as all workflow parmaters within files printed to `<outdir>/pipeline_info`.
...
!!! note "Key points"
    ...
    - nf-core pipeline_info files are a valuable resource to understanding and reproducing a run and contain information about compute resources used by the run
